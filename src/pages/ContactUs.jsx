...
export default function ContactUs() {
  ...
  return (
    <>
      ...
      <footer className="bg-gradient-to-r from-blue-900 via-cyan-900 to-blue-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-gray-300 text-lg">© 2025 POMI - Paiton Operation &amp; Maintenance Indonesia. All rights reserved.</p>
        </div>
      </footer>
    </>
  );
