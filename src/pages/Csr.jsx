  ...
  return (
    <>
      ...
      >
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-orange-900/80 via-orange-800/70 to-amber-900/80" />
        
        {/* Animated overlay patterns */}
        <div className="absolute inset-0 opacity-20">
          <div className="absolute top-0 left-0 w-96 h-96 bg-orange-400 rounded-full filter blur-3xl animate-pulse" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
          <div className="text-white max-w-3xl">
            <div className="mb-4 inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full border border-white/20">
              <Heart size={16} className="text-orange-300 animate-heartbeat" />
              <span className="text-sm font-medium">Community & Sustainability</span>
            </div>
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-4 animate-fade-in-up">
              Corporate Social Responsibility
            </h1>
            <p className="text-lg md:text-xl lg:text-2xl text-orange-100 animate-fade-in-up animation-delay-200">
